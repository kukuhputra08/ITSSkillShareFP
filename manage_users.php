...
// Hitung total user
$result_count = $conn->query('SELECT COUNT(*) AS total FROM user');
$total_users = $result_count->fetch_assoc()['total'];
$total_pages = ceil($total_users / $limit);

// Ambil data user untuk halaman ini (pakai prepared statement)
...
<body>
  <div class="container">
    ...
    <a href="registrasi.php?from=manage_users" class="btn btn-primary mb-4" style="border-radius: 24px;">Tambah Pengguna Baru</a>
